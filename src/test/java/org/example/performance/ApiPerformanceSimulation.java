...
public class ApiPerformanceSimulation extends Simulation {
    ...
    ActionBuilder incrementarGosteiRequest = http("incrementar gostei")
            .put("/mensagens/#{mensagemId}/gostei")
            .check(status().is(200));
    ...
    ScenarioBuilder cenarioIncrementarGostei = scenario("Incrementar Gostei")
        .exec(adicinarMensagemRequest)
        .exec(incrementarGosteiRequest);

    {
        setUp(
            ...
            cenarioIncrementarGostei.injectOpen(
                    rampUsersPerSec(1)
                            .to(30)
                            .during(Duration.ofSeconds(10)),
                    constantUsersPerSec(30)
